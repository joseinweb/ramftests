...
void Application::createMainMenu() {
    mainMenu.addOption("Check RDK App managers status", [this]() { this->checkStatus(); });
    mainMenu.addOption("App Manager related functions", [this]() { this->showAppManagerMenu(); });
    mainMenu.addOption("Package Manager related functions", [this]() { this->showPackageManagerMenu(); });
    mainMenu.addOption("Perform Catalog retrieval", [this]() { this->performCatalogRetrieval(); });
    mainMenu.addOption("Performance tests", [this]() { this->showPerformanceTests(); });
